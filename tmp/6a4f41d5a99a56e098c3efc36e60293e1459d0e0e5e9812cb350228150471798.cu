...
KERNEL void ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__multiexp(
    GLOBAL ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__affine *bases,
    GLOBAL ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__jacobian *buckets,
    GLOBAL ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__jacobian *results,
    GLOBAL ag_types__impls__ark_ff__fields__models__fp__Fp_ark_ff__fields__models__fp__montgomery_backend__MontBackend_ark_bls12_381__fields__fr__FrConfig__4___4__repr *exps,
    uint n,
    uint num_groups,
    uint num_windows,
    uint window_size) {
  ...
  const ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__jacobian local_zero = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__ZERO;
  ...
  const ushort w = min((ushort)window_size, (ushort)(ag_types__impls__ark_ff__fields__models__fp__Fp_ark_ff__fields__models__fp__montgomery_backend__MontBackend_ark_bls12_381__fields__fr__FrConfig__4___4__BITS - bits));

  ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__jacobian res = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__ZERO;
  for(uint i = nstart; i < nend; i++) {
    uint ind = ag_types__impls__ark_ff__fields__models__fp__Fp_ark_ff__fields__models__fp__montgomery_backend__MontBackend_ark_bls12_381__fields__fr__FrConfig__4___4__get_bits(exps[i], bits, w);
      ...
      if(ind == 511) buckets[510] = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__add_mixed(buckets[510], bases[i]);
      else if(ind--) buckets[ind] = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__add_mixed(buckets[ind], bases[i]);
    #else
      if(ind--) buckets[ind] = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__add_mixed(buckets[ind], bases[i]);
    #endif
  }
  ...
  //                    (a) + b +
  //                    ((a) + b) + c
  ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__jacobian acc = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__ZERO;
  for(int j = bucket_len - 1; j >= 0; j--) {
    acc = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__add(acc, buckets[j]);
    res = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bls12_381__curves__g1__Config__add(res, acc);
  }
