 ...
 */
KERNEL void ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__radix_fft(GLOBAL ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__jacobian* x, // Source buffer
                      GLOBAL ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__jacobian* y, // Destination buffer
                      ...
                      LOCAL ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__jacobian* u_arg, // Local buffer to store intermediary values
...
// ignore that argument and use the globally defined extern memory instead.
  ...
  ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__jacobian* u = (ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__jacobian*)cuda_shared;
#else
  LOCAL ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__jacobian* u = u_arg;
#endif
  ...
  for(uint i = counts; i < counte; i++) {
    u[i] = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__mul(x[i*t], tmp);
  ...
  for(uint rnd = 0; rnd < deg; rnd++) {
    ...
    for(uint i = counts >> 1; i < counte >> 1; i++) {
      ...
      ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__jacobian tmp_point = u[i0];
      u[i0] = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__add(u[i0], u[i1]);
      u[i1] = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__sub(tmp_point, u[i1]);
      ag_types__impls__ark_ff__fields__models__fp__Fp_ark_ff__fields__models__fp__montgomery_backend__MontBackend_ark_bn254__fields__fr__FrConfig__4___4_ pq_pow = ag_types__impls__ark_ff__fields__models__fp__Fp_ark_ff__fields__models__fp__montgomery_backend__MontBackend_ark_bn254__fields__fr__FrConfig__4___4__pow(pq[0], di << rnd << pqshift);
      u[i1] = ag_types__impls__ark_ec__models__short_weierstrass__affine__Affine_ark_bn254__curves__g1__Config__mul(u[i1], pq_pow);
    }
